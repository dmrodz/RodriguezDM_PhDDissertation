################################################################################
print('Starting BILSTM EDK-Layer for BiLSTM algorithm.')
################################################################################
...
write.csv(results_per_class_edk, 
          paste0(path, '/bilstm_hp_class_lv_metrics_edk - data ', ii, '.csv'),
          row.names = FALSE)
write.csv(results_overall_edk, 
          paste0(path, '/bilstm_hp_overall_metrics_edk - data ', ii, '.csv'),
          row.names = FALSE)
